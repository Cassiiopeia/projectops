...
def build_parser() -> JSONArgumentParser:
    parser = JSONArgumentParser(prog="ppt_cli", description="ppt skill CLI")
    sub = parser.add_subparsers(dest="command", required=True)

    p_gop = sub.add_parser("get-output-path", help="프레젠테이션 산출물 출력 경로")
    p_gop.add_argument("skill_id", nargs="?", default="ppt")
