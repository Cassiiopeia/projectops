...
SCRIPTS="$PROJECT_ROOT/skills/pro-analyze/scripts"; [ -d "$SCRIPTS" ] || SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/projectops/*/skills/pro-analyze/scripts 2>/dev/null | sort -V | tail -1); cd "$SCRIPTS" || exit 1
