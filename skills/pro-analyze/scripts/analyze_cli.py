#!/usr/bin/env python3
"""analyze_cli — analyze skill 전용 CLI.
...
def build_parser() -> JSONArgumentParser:
    parser = JSONArgumentParser(prog="analyze_cli", description="analyze skill CLI")
    sub = parser.add_subparsers(dest="command", required=True)

    p_gop = sub.add_parser("get-output-path", help="코드 분석 결과 출력 경로")
    p_gop.add_argument("skill_id", nargs="?", default="analyze")
