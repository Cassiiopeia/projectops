#!/usr/bin/env python3
"""design_analyze_cli — design-analyze skill 전용 CLI.
...
def build_parser() -> JSONArgumentParser:
    parser = JSONArgumentParser(prog="design_analyze_cli", description="design-analyze skill CLI")
    sub = parser.add_subparsers(dest="command", required=True)

    p_gop = sub.add_parser("get-output-path", help="설계 분석 결과 출력 경로")
    p_gop.add_argument("skill_id", nargs="?", default="design-analyze")
