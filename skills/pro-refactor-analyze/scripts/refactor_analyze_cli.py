#!/usr/bin/env python3
"""refactor_analyze_cli — refactor-analyze skill 전용 CLI.
...
def build_parser() -> JSONArgumentParser:
    parser = JSONArgumentParser(prog="refactor_analyze_cli", description="refactor-analyze skill CLI")
    sub = parser.add_subparsers(dest="command", required=True)

    p_gop = sub.add_parser("get-output-path", help="리팩토링 분석 결과 출력 경로")
    p_gop.add_argument("skill_id", nargs="?", default="refactor-analyze")
